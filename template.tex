% For a shorter document, change course to seminar
...
\title{Main title of the lecture} % Main title of the lecture
\subtitle{Subtitle of the lecture} % Subtitle of the lecture
\shorttitle{Shortened title} % Shortened Title - For headers; if undefined, the usual title will be used
\ccode{Code 7.45} % Most of these data are not compulsory
\subject{Subject of the Talk} % Subject of the lecture/talk
\author{Author's name} % Author of the notes
\spemail{speaker@email.com} % Email of the speaker
\email{email@email.com} % Email of the note taker
\speaker{Speaker's name} % Name of the speaker
\date{02}{11}{2134} % Date this was written
\dateend{07}{11}{2134} % Date the lectures ended
\conference{Lecture hall 7} % What location in the place
\place{University of Physics} % Where the lecture was given
\flag{An extra line if you need it.} % An extra line if needed
...
\morelink{vhbelvadi.com} % A link for more details
%
